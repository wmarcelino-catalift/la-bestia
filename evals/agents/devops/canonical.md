...
Snapshot evaluation for the `devops` agent. Run via `bash evals/run.sh devops`.
...
```
(operator prompt that should trigger @devops)
```
...
- Output contract sections per `config/agents/devops.md`
