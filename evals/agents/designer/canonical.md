...
Snapshot evaluation for the `designer` agent. Run via `bash evals/run.sh designer`.
...
```
(operator prompt that should trigger @designer)
```
...
- Output contract sections per `config/agents/designer.md`
