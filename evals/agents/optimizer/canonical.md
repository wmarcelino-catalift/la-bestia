...
Snapshot evaluation for the `optimizer` agent. Run via `bash evals/run.sh optimizer`.
...
```
(operator prompt that should trigger @optimizer)
```
...
- Output contract sections per `config/agents/optimizer.md`
