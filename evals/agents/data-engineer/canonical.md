...
Snapshot evaluation for the `data-engineer` agent. Run via `bash evals/run.sh data-engineer`.
...
```
(operator prompt that should trigger @data-engineer)
```
...
- Output contract sections per `config/agents/data-engineer.md`
