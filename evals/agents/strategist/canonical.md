...
Snapshot evaluation for the `strategist` agent. Run via `bash evals/run.sh strategist`.
...
```
(operator prompt that should trigger @strategist)
```
...
- Output contract sections per `config/agents/strategist.md`
