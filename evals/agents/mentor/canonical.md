...
Snapshot evaluation for the `mentor` agent. Run via `bash evals/run.sh mentor`.
...
```
(operator prompt that should trigger @mentor)
```
...
- Output contract sections per `config/agents/mentor.md`
