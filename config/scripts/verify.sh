...
echo ""
echo "[Structure: $CDIR]"
check "agents/ (>= 15)"         "[ \$(ls \"$CDIR/agents\"/*.md 2>/dev/null | wc -l) -ge 15 ]"
check "skills/ (>= 6)"          "[ \$(ls -d \"$CDIR/skills\"/*/ 2>/dev/null | wc -l) -ge 6 ]"
check "commands/ (>= 15)"       "[ \$(ls \"$CDIR/commands\"/*.md 2>/dev/null | wc -l) -ge 15 ]"
check "hooks/ (>= 9)"           "[ \$(ls \"$CDIR/hooks\"/*.sh 2>/dev/null | wc -l) -ge 9 ]"
check "scripts/ (>= 3)"         "[ \$(ls \"$CDIR/scripts\"/*.sh 2>/dev/null | wc -l) -ge 3 ]"
check "bin/ (>= 9)"             "[ \$(ls \"$CDIR/bin\"/*.sh 2>/dev/null | wc -l) -ge 9 ]"
